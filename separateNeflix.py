...
for i in range(0,15,3):
    ...
    with open('seed'+str(num_seed)+'Netflix_test'+str(contador)+'.csv', 'w', newline='') as csvfile:
    ...
    with open('seed'+str(num_seed)+'Netflix_train'+str(contador)+'.csv', 'w', newline='') as csvfile:
